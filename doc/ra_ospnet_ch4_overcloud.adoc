...
----
 ...
 parameter_defaults:
  ...
  BondInterfaceOvsOptions:
      "mode=4 lacp_rate=1 updelay=1000 miimon=100"
----
...
==== Changes to Network Configuration in {ro} Director 7.3
The primary change to the networking in {ro} Director 7.3 was the addition
of IPv6 networking. The isolated Overcloud networks can now be deployed as
...
you will now find an alternate version of the _controller.yaml_, named
